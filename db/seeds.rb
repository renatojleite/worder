...
WorkOrder.create!(team_leader: team_leader, name: "job1", priority: 1, status: 2, due_date: DateTime.new(2001,2,3,4,5,6), address: "Avenida Brigadeiro Faria Lima, 3400", description: descricao)
WorkOrder.create!(team_leader: team_leader2, name: "job2", priority: 1, status: 3, due_date: DateTime.new(2001,2,3,4,5,6), address: "Avenida Chucri Zaidan, 900", description: descricao)
WorkOrder.create!(team_leader: team_leader, name: "job3", priority: 3, status: 1, due_date: DateTime.new(2001,2,3,4,5,6), address: "Rua Joaquim Eugenio de Lima, 844", description: descricao)
WorkOrder.create!(team_leader: team_leader, name: "job4", priority: 2, status: 2, due_date: DateTime.new(2001,2,3,4,5,6), address: "Rua Capote Valente, 222", description: descricao)
WorkOrder.create!(team_leader: team_leader2, name: "job5", priority: 3, status: 3, due_date: DateTime.new(2010,2,3,4,5,6), address: "Al Santos, 70", description: descricao)
WorkOrder.create!(team_leader: team_leader, name: "job6", priority: 1, status: 2, due_date: DateTime.new(2010,2,3,4,5,6), address: "Rua Verbo Divino, 1784", description: descricao)
